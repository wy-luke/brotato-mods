...
const BFX_LOG_MAIN = "DoDaLi-ShowDPS"
...
# When you level up
func on_levelled_up(i: int)->void:
	.on_levelled_up(i)
#	_bfx_on_levelup_gain_random_stat()


# When you collect a consumable
func on_consumable_picked_up(consumable:Node, i:int)->void:
	.on_consumable_picked_up(consumable, i)
